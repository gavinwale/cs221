 ...
 * Tests for Change Scenario 41: [A, B] -> addToFront(C) -> [C, A, B]
 * 
 * @author gavinwale
 */
public class Test_17_AB_addToFrontC_CAB {
	...
	//****** Constants used in tests *****************
		// Name of class
		private static String CLASS_NAME = "Test_17_AB_addToFrontC_CAB";
		// Description of change scenario testing
		private static final String testDescription =
				"Change Scenario 17: [A, B] -> addToFrontC -> [C, A, B]";
		// Number of tests run
